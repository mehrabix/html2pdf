...
public class PdfRequest {
    private List<String> htmlPages; // Each string is a page (can be one for single-page)
    private Map<String, String> globalOptions; // e.g. paper size, orientation, margins
    private List<Map<String, String>> pageOptions; // Per-page options (optional)
    private String scheduledTime; // ISO8601 string for delayed jobs (optional)
